...
public class ActivityTests
{
    ...
    //     // Assert
    //     var expectedOutput =
    //         $"Sending notification to scrum master Sending email notification: {activity} Sending email notification: {activity} Sending email notification: {activity} Sending email notification: {activity}";
    //     
    //     Assert.Multiple(() =>
    //     {
