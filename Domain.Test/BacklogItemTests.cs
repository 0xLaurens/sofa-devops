...
public class BacklogItemTests
{
    ...
    // {
    //     var backlog = new Backlog("Domain.Test Backlog");
    ...
    //     var user2 = new Developer("lead-developer", "email@leaddeveloper.nl");
    //     
    //     var activity = new Activity("test activity", user, backlogItem);
    //     var activity2 = new Activity("test activity 2", user2, backlogItem);
    //     var activity3 = new Activity("test activity 3", user2, backlogItem);
    //    
